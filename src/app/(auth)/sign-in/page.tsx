  ...
  return (
    <div className="mx-auto max-w-md p-6">
      ...
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        <button disabled={loading} className="bg-[hsl(var(--brand))] text-white rounded px-4 py-2">{loading? 'Signing in...' : 'Sign in'}</button>
      </form>
      <div className="mt-4 text-sm">
        <Link href="/sign-up" className="underline mr-4">Create account</Link>
