...
const option = {
  ...
  yAxis: { type:'value' },
  series: [
    { type:'bar', stack:'total', itemStyle:{ borderColor:'transparent', color:'transparent' }, data: base },
    { name:'Increase', type:'bar', stack:'total', data: increase, itemStyle:{ color:'#2EAC69' } },
    { name:'Decrease', type:'bar', stack:'total', data: decrease, itemStyle:{ color:'#D92D20' } }
  ]
};
